angular.module("unlMainApp").controller('mainController', function mainController($scope, $http, $location, $window, $uibModal, $log, $rootScope, FileUploader, focus, $timeout, $cookies, themeService) {
	...
	var translations = {
		en: {
			...
			modalCollaborateRequirement: 'Enable Shared lab to allow collaboration.',
			...
			validationLabExists: 'Lab with this name already exists.',
			validationLabNameRequired: 'Lab name is required.',
			actionApply: 'Apply',
			actionRename: 'Rename',
			actionDelete: 'Delete',
			actionMove: 'Move',
		...
		ru: {
			...
			modalCollaborateRequirement: 'Включите "Общую лабу", чтобы разрешить совместную работу.',
			...
			validationLabExists: 'Лаборатория с таким именем уже существует.',
			validationLabNameRequired: 'Имя лаборатории обязательно.',
