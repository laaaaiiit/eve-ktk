...
$messages[20] = 'Flag -U is missing (20).';
$messages[21] = 'Flag -U is not valid (21).';
...
$messages[20046] = 'Max nodes reached (256)';
...
$messages[90014] = 'Неверное имя пользователя или пароль. При необходимости обратитесь к администратору (90014).';
